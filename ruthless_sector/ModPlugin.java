...
public class ModPlugin extends BaseModPlugin {
    ...
    public static final double
            TIMESTAMP_TICKS_PER_DAY = 8.64E7D;
    ...
    static boolean readSettings() throws Exception {
        ...
        RESTRICT_REP_GAIN_TO_WHITLISTED_FACTIONS = getBoolean("restrictRepGainToWhitelistedFactions");
...
//            MAX_BATTLE_DIFFICULTY_ESTIMATION = getFloat("maxBattleDifficultyEstimation");
    ...
    static boolean readSettingsIfNecessary(boolean forceRefresh) {
        try {
            ...
            Set<String> wl = RESTRICT_REP_GAIN_TO_WHITLISTED_FACTIONS ? fetchList(FACTION_WL_PATH) : null;
